...
import imgIllustrationHybrid1 from "@/assets/4a694fe37c89e831b17ffcc945ced9c8d1ccbca5.webp";
...
export default function Frame() {
  return (
    <div className="content-stretch flex items-start justify-between relative size-full">
        ...
        <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0">
          <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
            <div className="bg-white content-stretch flex items-center justify-center px-[16px] py-[8px] relative rounded-[20px] shrink-0">
              ...
              <p className="font-['Aeonik:Regular',sans-serif] h-[21.469px] leading-[normal] not-italic relative shrink-0 text-[#40295b] text-[16px] w-[89px]">Design Lead</p>
            </div>
            <div className="bg-white content-stretch flex items-center justify-center px-[16px] py-[8px] relative rounded-[20px] shrink-0">
              <div aria-hidden="true" className="absolute border-4 border-[#eeedff] border-solid inset-0 pointer-events-none rounded-[20px]" />
              <p className="font-['Aeonik:Regular',sans-serif] h-[21px] leading-[normal] not-italic relative shrink-0 text-[#40295b] text-[16px] w-[89px]">1 PM, 4 Devs</p>
            </div>
            <div className="bg-white content-stretch flex items-center justify-center px-[16px] py-[8px] relative rounded-[20px] shrink-0">
              <div aria-hidden="true" className="absolute border-4 border-[#eeedff] border-solid inset-0 pointer-events-none rounded-[20px]" />
          ...
          <p className="font-['Aeonik:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#40295b] text-[60px] tracking-[18px] uppercase w-[547px]">Optimiser le temps médical</p>
          <p className="font-['Aeonik:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#40295b] text-[32px] w-[459.885px]">{`Passer d'une interface exhaustive à une interface contextuelle pour libérer 40% de temps administratif`}</p>
        </div>
          ...
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex font-['Aeonik:Regular',sans-serif] items-center justify-between leading-[normal] not-italic px-[40px] py-[32px] relative text-[#40295b] text-center w-full">
              <div className="content-stretch flex flex-col gap-[2px] items-center relative shrink-0 w-[132px]">
                <p className="min-w-full relative shrink-0 text-[32px] w-[min-content]">-30s</p>
                <p className="relative shrink-0 text-[16px] w-[136.537px]">par consultation</p>
              </div>
              <div className="content-stretch flex flex-col gap-[2px] items-center relative shrink-0 w-[132px]">
                <p className="min-w-full relative shrink-0 text-[32px] w-[min-content]">+13%</p>
                <p className="relative shrink-0 text-[16px] whitespace-nowrap">de temps libéré</p>
              </div>
              <div className="content-stretch flex flex-col gap-[2px] items-center relative shrink-0 w-[132px]">
                <p className="relative shrink-0 text-[32px] w-full">43%</p>
                <p className="relative shrink-0 text-[16px] w-full">d’adoption</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="h-[538.367px] relative shrink-0 w-[425.5px]" data-name="Illustration hybrid 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgIllustrationHybrid1} />
      </div>
    </div>
  );
}