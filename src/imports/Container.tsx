...
import imgPicture from "@/assets/c56d5debaacac6566dcecd8d88a82d82ecdd2621.webp";
...
export default function Container() {
  return (
    <div className="bg-[#f2effa] content-stretch flex flex-col gap-[24px] items-start pl-[32px] pr-[36px] py-[32px] relative rounded-[24px] size-full" data-name="Container">
      ...
      <div className="absolute bg-[#3c3162] left-[32px] rounded-[24px] top-[437px] w-[387px]">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[16px] items-center p-[16px] relative w-full">
          ...
          <div className="-translate-x-1/2 absolute flex items-center justify-center left-1/2 size-[42.475px] top-[-20.22px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
            <div className="flex-none rotate-45">
              <div className="relative size-[30.035px]">
                <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30.0347 30.0347">
                  <path d={svgPaths.p159d3000} fill="var(--fill-0, #3C3162)" id="Rectangle 240648531" />
                </svg>
              </div>
            </div>
          </div>
