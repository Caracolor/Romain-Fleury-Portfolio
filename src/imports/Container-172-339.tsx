import svgPaths from "./svg-itskiwb6lj";
...
function Icon1() {
  return (
    <div className="h-[10px] overflow-clip relative shrink-0 w-full">
      <div className="absolute inset-[0_-4360%_0_4360%]" data-name="vector">
...
function Icon() {
  return (
    <div className="h-[7.922px] overflow-clip relative shrink-0 w-full">
      <div className="absolute inset-[0_-4183.51%_0_4183.51%]" data-name="vector">
