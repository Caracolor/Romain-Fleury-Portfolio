import imgLogiqueAutourDuNoShowDoubleCalls1 from "figma:asset/c1cc6a616be8de19fe5f8895eabaddff80aea7c6.png";
      ...
      <div className="content-stretch flex flex-col gap-[52px] items-start relative shrink-0 w-[800px]">
        ...
        <div className="content-stretch flex flex-col gap-[40px] items-start justify-center relative shrink-0 w-full">
          ...
          <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0">
            <div className="h-[508.157px] relative shrink-0 w-[800px]" data-name="Logique autour du no-Show - double calls 1">
              <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgLogiqueAutourDuNoShowDoubleCalls1} />
            </div>
            <p className="font-['Aeonik:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#40295b] text-[16px] text-center w-[800px]">Logique autour de la déclaration des no-show</p>
          </div>
