...
import imgRectangle1 from "@/assets/f776a534aef1cb13cd22e25a8a1b6f4a69a03846.webp";
...
function ParagraphBackgroundImage({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="content-stretch flex h-[21.5px] items-start relative shrink-0 w-full">
      <p className="flex-[1_0_0] font-['Aeonik:Bold',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[#16121b] text-[18px] whitespace-pre-wrap">{children}</p>
    </div>
  );
}
...
function HeadingBackgroundImage({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="content-stretch flex h-[29px] items-start relative shrink-0 w-[378.508px]">
      <p className="font-['Aeonik:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#7a63ca] text-[24px] tracking-[4.8px] uppercase">{children}</p>
    </div>
  );
}
...
function BackgroundImage6({ children }: React.PropsWithChildren<{}>) {
  return (
    <div aria-hidden="true" className="absolute inset-0 rounded-[30px]">
      ...
      <div className="absolute inset-0 overflow-hidden rounded-[30px]">{children}</div>
      <div className="absolute bg-[rgba(59,58,87,0.05)] inset-0 rounded-[30px]" />
    </div>
  );
}
type Frame4BackgroundImageProps = {
  additionalClassNames?: string;
};

function Frame4BackgroundImage({ children, additionalClassNames = "" }: React.PropsWithChildren<Frame4BackgroundImageProps>) {
  return (
    <div className={clsx("h-[341px] justify-self-stretch relative rounded-[30px] shrink-0", additionalClassNames)}>
...
function ContainerBackgroundImage1({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="bg-[#feeff2] h-[96px] relative rounded-[14px] shrink-0 w-full">
      ...
      <BackgroundImage7>{children}</BackgroundImage7>
    </div>
  );
}
...
function ContainerBackgroundImage({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="bg-[#f6fcf9] h-[96px] relative rounded-[14px] shrink-0 w-full">
      <div aria-hidden="true" className="absolute border-3 border-[#a4e0c6] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <BackgroundImage7>{children}</BackgroundImage7>
    </div>
  );
}
...
function BackgroundImage5({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="bg-white relative rounded-[30px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex font-['Aeonik:Regular',sans-serif] items-center justify-between leading-[normal] not-italic px-[56px] py-[32px] relative text-[#16121b] text-center w-full">{children}</div>
      </div>
    </div>
  );
}
...
function BackgroundImage4({ text, text1 }: BackgroundImage4Props) {
  return (
    <button className="bg-white content-stretch cursor-pointer flex gap-[16px] items-center p-[24px] relative rounded-[30px] shrink-0 w-[430px]">
      ...
      <div className="flex flex-col font-['Aeonik:Regular',sans-serif] h-[52px] justify-center leading-[0] not-italic relative shrink-0 text-[#16121b] text-[43px] text-left w-[40px]">
        <p className="leading-[26px] whitespace-pre-wrap">{text}</p>
      </div>
      <p className="flex-[1_0_0] font-['Aeonik:Regular',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[#16121b] text-[20px] text-left whitespace-pre-wrap">{text1}</p>
    ...
    <div className="overflow-clip relative shrink-0 size-[23.695px]">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[15.797px] left-1/2 top-1/2 w-[23.695px]" data-name="vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23.6951 15.7969">
          <path clipRule="evenodd" d={svgPaths.p1c2d7c00} fill="var(--fill-0, #16121B)" fillRule="evenodd" id="vector" />
        </svg>
      </div>
    </div>
  );
...
function BackgroundImage2({ text, text1 }: BackgroundImage2Props) {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col font-['Aeonik:Regular',sans-serif] gap-[16px] items-start leading-[normal] min-h-px min-w-px not-italic relative text-[#16121b] whitespace-pre-wrap">
...
function BackgroundImage1({ text, text1 }: BackgroundImage1Props) {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-center relative shrink-0 w-[132px]">
      <p className="min-w-full relative shrink-0 text-[32px] w-[min-content] whitespace-pre-wrap">{text}</p>
      <p className="relative shrink-0 text-[12px]">{text1}</p>
    </div>
  );
}
...
export default function PortfolioPageCreation() {
  return (
    <div className="content-stretch flex flex-col gap-[138px] items-center pb-[240px] pt-[80px] px-[200px] relative size-full" data-name="Portfolio page creation" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\'0 0 1672 8870.8\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'1\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(62.665 214.39 -40.41 166.02 35.126 179.1)\\'><stop stop-color=\\'rgba(255,255,255,1)\\' offset=\\'0\\'/><stop stop-color=\\'rgba(255,255,255,0)\\' offset=\\'0.75332\\'/><stop stop-color=\\'rgba(255,255,255,1)\\' offset=\\'1\\'/></radialGradient></defs></svg>'), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <div className="content-stretch flex items-center justify-between relative shrink-0 w-[1100px]" data-name="Header">
        <div className="content-stretch flex gap-[57px] items-center relative shrink-0">
          <div className="h-[72px] relative shrink-0 w-[52px]" data-name="Caracolor logo">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 52 72">
              <g clipPath="url(#clip0_41_1636)" id="Caracolor logo">
                <path d={svgPaths.p2d243d70} fill="var(--fill-0, #16121B)" id="Vector" />
                <path d={svgPaths.p12205e00} fill="var(--fill-0, #16121B)" id="Vector_2" />
                <path d={svgPaths.p2c77ea00} fill="var(--fill-0, #16121B)" id="Vector_3" />
              </g>
              <defs>
                <clipPath id="clip0_41_1636">
                  <rect fill="white" height="72" width="52" />
                </clipPath>
              </defs>
            </svg>
          </div>
          <div className="content-stretch flex font-['Aeonik:Regular',sans-serif] gap-[48px] items-center leading-[normal] not-italic relative shrink-0 text-[#16121b] text-[16px]">
            <p className="relative shrink-0">About</p>
            <p className="relative shrink-0">Projects</p>
            <p className="relative shrink-0">Experience</p>
          </div>
        </div>
        <p className="decoration-solid font-['Aeonik:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#16121b] text-[16px] underline">r.s.fleury@gmail.com</p>
      </div>
      <div className="content-stretch flex flex-col gap-[180px] items-center relative shrink-0 w-[1100px]">
        <div className="content-stretch flex gap-[40px] items-center relative shrink-0 w-[1100px]">
          <div className="content-stretch flex flex-col gap-[64px] items-start relative shrink-0 w-[550px]">
            ...
            <BackgroundImage5>
              ...
              <BackgroundImage1 text="+56%" text1="Croissance mensuelle moyenne" />
          ...
          <div className="h-[654.056px] relative shrink-0 w-[501.38px]">
            <div className="absolute h-[736.57px] left-[-75.94px] top-[-117.3px] w-[577.01px]" data-name="Image des programmes">
              <div className="absolute flex h-[638.651px] items-center justify-center left-[55.97px] top-[106.86px] w-[397.489px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "19" } as React.CSSProperties}>
              ...
              <div className="absolute h-[675.225px] left-[211.68px] top-[193.36px] w-[444.214px]" data-name="Shape 1">
        ...
        <div className="content-stretch flex h-[815px] items-start relative shrink-0 w-[946px]">
          <div className="content-stretch flex flex-[1_0_0] flex-col gap-[56px] h-[702px] items-start min-h-px min-w-px relative">
            <div className="content-stretch flex flex-col gap-[8px] items-start not-italic relative shrink-0 w-[701px] whitespace-pre-wrap">
              ...
              <p className="font-['Aeonik:Bold',sans-serif] leading-[45px] relative shrink-0 text-[#16121b] text-[36px] w-full">{`De la recherche à l'exécution`}</p>
              <p className="font-['Aeonik:Regular',sans-serif] leading-[30px] relative shrink-0 text-[#16121b] text-[24px] w-full">{`J'ai conduit la recherche utilisateur et assuré la conception de bout en bout du premier programme Shape, qui a défini la stratégie pour que d’autres product designers prennent la suite. `}</p>
            </div>
            <div className="content-stretch flex gap-[80px] items-center relative shrink-0 w-full">
              <div className="flex flex-row items-center self-stretch">
                <div className="content-stretch flex flex-col gap-[24px] h-full items-end justify-center relative shrink-0 w-[420px]">
                  ...
                  <p className="font-['Aeonik:Regular',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[#16121b] text-[16px] text-center w-[min-content] whitespace-pre-wrap">Illustration : Shape mobile landing page</p>
                </div>
              </div>
              <div className="content-stretch flex flex-[1_0_0] flex-col gap-[32px] items-start justify-center min-h-px min-w-px relative">
                <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full">
                  <div className="bg-[rgba(77,71,180,0.2)] rounded-[10px] self-stretch shrink-0 w-[4px]" />
        ...
        <div className="content-stretch flex flex-col gap-[56px] items-start relative shrink-0 w-[946px]">
          <div className="content-stretch flex flex-col gap-[8px] items-start not-italic relative shrink-0 w-[706px] whitespace-pre-wrap">
            ...
            <div className="font-['Aeonik:Bold',sans-serif] leading-[45px] relative shrink-0 text-[#16121b] text-[36px] w-full">
              <p className="mb-0">{`Les patients souhaites `}</p>
              <p>un accompagnement continue d’une équipe pluridiciplinaire</p>
            </div>
            <p className="font-['Aeonik:Regular',sans-serif] leading-[30px] relative shrink-0 text-[#16121b] text-[24px] w-full">{`Les patients ne veulent pas une app digitale ou suivre un programme en autonomie, ils veulent échanger régulièrement avec des professionnels de santés. `}</p>
          </div>
              ...
              <div className="content-stretch flex gap-[56px] items-center relative w-full">
                <div className="flex flex-[1_0_0] flex-row items-center self-stretch">
                  <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] h-full items-start min-h-px min-w-px relative">
                    ...
                    <p className="font-['Times_New_Roman:Bold_Italic',sans-serif] italic leading-[normal] min-w-full relative shrink-0 text-[#7a63ca] text-[30px] w-[min-content] whitespace-pre-wrap">{`Moi, je suis responsable de service avec beaucoup de responsabilité, donc j'ai besoin de parler, de vider mon sac`}</p>
                    <p className="font-['Aeonik:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#16121b] text-[16px] w-[350px] whitespace-pre-wrap">Interview téléphonique - Mind</p>
                  </div>
                </div>
                <div className="flex flex-[1_0_0] flex-row items-center self-stretch">
                  <div className="content-stretch flex flex-[1_0_0] flex-col gap-[11px] h-full items-start min-h-px min-w-px relative">
                    ...
                    <p className="font-['Times_New_Roman:Bold_Italic',sans-serif] italic leading-[normal] min-w-full relative shrink-0 text-[#7a63ca] text-[30px] w-[min-content] whitespace-pre-wrap">Je veux une équipe qui me comprend et me suit sur le long terme, pas juste une consultation isolée</p>
                    <p className="font-['Aeonik:Regular',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[#16121b] text-[16px] w-[min-content] whitespace-pre-wrap">Interview téléphonique - Shape</p>
                  </div>
                </div>
          ...
          <div className="bg-[#f2effa] relative rounded-[30px] shrink-0 w-full">
            ...
            <div className="flex flex-row items-center size-full">
              <div className="content-stretch flex gap-[30px] items-center p-[32px] relative w-full">
                ...
                <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start leading-[26px] min-h-px min-w-px not-italic relative text-[#16121b] whitespace-pre-wrap">
            ...
            <div className="content-stretch flex flex-col items-center justify-center px-[40px] py-[50px] relative w-full">
              <div className="content-stretch flex flex-col gap-[56px] items-start relative shrink-0">
                <div className="content-stretch flex flex-col gap-[8px] items-start not-italic relative shrink-0 w-[706px] whitespace-pre-wrap">
                  ...
                  <p className="font-['Aeonik:Bold',sans-serif] leading-[45px] relative shrink-0 text-[#16121b] text-[36px] w-full">{`L’interface n’est qu'un facilitateur`}</p>
                  <p className="font-['Aeonik:Regular',sans-serif] leading-[30px] relative shrink-0 text-[#16121b] text-[24px] w-full">Le cœur de notre service repose sur une prise en charge médicale de qualité, accessible rapidement et dans la durée.</p>
                </div>
                <div className="content-stretch flex gap-[40px] h-[426px] items-center relative shrink-0 w-[946px]">
                  <div className="content-stretch flex flex-col gap-[33px] items-start relative shrink-0 w-[430px]">
                    <div className="bg-white content-stretch flex gap-[16px] items-center p-[24px] relative rounded-[30px] shrink-0 w-[430px]">
                      ...
                      <p className="flex-[1_0_0] font-['Aeonik:Regular',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[#16121b] text-[20px] whitespace-pre-wrap">{`Navigation de l'app Qare repensée pour faire de la place aux programmes`}</p>
                      <Helper24StrokeArrowBackgroundImage />
                    </div>
                  ...
                  <div className="content-stretch flex flex-[1_0_0] flex-col gap-[20.286px] h-full items-center justify-center min-h-px min-w-px overflow-clip relative">
                    ...
                    <p className="font-['Aeonik:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#16121b] text-[16px] text-center w-full whitespace-pre-wrap">Simplification puis réorganisation de l’application puis ajout des éléments des programmes (en violet)</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="content-stretch flex flex-col items-start relative shrink-0" style={{ backgroundImage: "linear-gradient(184.638deg, rgb(255, 255, 255) 11.415%, rgba(255, 255, 255, 0.18) 37.968%, rgba(255, 255, 255, 0) 74.845%, rgb(255, 255, 255) 96.384%)" }}>
        ...
        <div className="content-stretch flex flex-col gap-[56px] items-start relative shrink-0 w-[946px]" data-name="Container">
          <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[706px]" data-name="Container">
            ...
            <div className="font-['Aeonik:Bold',sans-serif] leading-[45px] min-w-full not-italic relative shrink-0 text-[#16121b] text-[36px] w-[min-content] whitespace-pre-wrap">
          ...
          <BackgroundImage5>
            ...
            <BackgroundImage text="2 179" text1="Patients actifs" />
            <div className="content-stretch flex flex-col gap-[2px] items-center relative shrink-0 w-[132px]">
              <p className="relative shrink-0 text-[32px]">75-85%</p>
              <p className="relative shrink-0 text-[12px]">de rétention estimée</p>
            </div>
            <BackgroundImage1 text="80%" text1="D’activation (contre 60% estimé)" />
          </BackgroundImage5>
            ...
            <ContainerBackgroundImage2>
              ...
              <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Container">
                <ContainerBackgroundImage>
                  ...
                  <p className="flex-[1_0_0] font-['Aeonik:Regular',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[#16121b] text-[20px] whitespace-pre-wrap">{`Inscription en ligne → pic d'inscriptions + réduction du goulot opérationnel`}</p>
                </ContainerBackgroundImage>
                <ContainerBackgroundImage>
                  <div className="content-stretch flex flex-col h-[7.922px] items-start relative shrink-0 w-[10.422px]" data-name="Container">
                    <IconBackgroundImage />
                  </div>
                  <p className="flex-[1_0_0] font-['Aeonik:Regular',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[#16121b] text-[20px] whitespace-pre-wrap">Ciblage déserts médicaux + message tiers-payant = combo gagnant</p>
                </ContainerBackgroundImage>
                <ContainerBackgroundImage>
                  <div className="content-stretch flex flex-col h-[7.922px] items-start relative shrink-0 w-[10.422px]" data-name="Container">
                    <IconBackgroundImage />
                  </div>
                  <p className="flex-[1_0_0] font-['Aeonik:Regular',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[#16121b] text-[20px] whitespace-pre-wrap">{`Promesse autour de l'équipe pluridisciplinaire spécialisée`}</p>
                </ContainerBackgroundImage>
                <ContainerBackgroundImage>
                  <div className="content-stretch flex flex-col h-[7.922px] items-start relative shrink-0 w-[10.422px]" data-name="Container">
                    <IconBackgroundImage />
                  </div>
                  <p className="flex-[1_0_0] font-['Aeonik:Regular',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[#16121b] text-[20px] whitespace-pre-wrap">Accompagnement constant : améliore acquisition ET rétention</p>
                </ContainerBackgroundImage>
                <ContainerBackgroundImage>
                  <div className="content-stretch flex flex-col h-[7.922px] items-start relative shrink-0 w-[10.422px]" data-name="Container">
                    <IconBackgroundImage />
                  </div>
                  <p className="flex-[1_0_0] font-['Aeonik:Regular',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[#16121b] text-[20px] whitespace-pre-wrap">{`Volume consultations en croissance constante — preuve d'engagement réel`}</p>
                </ContainerBackgroundImage>
              </div>
            </ContainerBackgroundImage2>
            <ContainerBackgroundImage2>
              ...
              <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Container">
                <ContainerBackgroundImage1>
                  ...
                  <p className="flex-[1_0_0] font-['Aeonik:Regular',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[#16121b] text-[20px] whitespace-pre-wrap">{`Mentionner les GLP-1 pour l'acquisition (sans impact)`}</p>
                </ContainerBackgroundImage1>
                <ContainerBackgroundImage1>
                  <div className="content-stretch flex flex-col items-start relative shrink-0 size-[10px]" data-name="Container">
                    <IconBackgroundImage1 />
                  </div>
                  <p className="flex-[1_0_0] font-['Aeonik:Regular',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[#16121b] text-[20px] whitespace-pre-wrap">Le contenu non personnalisé pour créer de la rétention</p>
                </ContainerBackgroundImage1>
                <ContainerBackgroundImage1>
                  <div className="content-stretch flex flex-col items-start relative shrink-0 size-[10px]" data-name="Container">
                    <IconBackgroundImage1 />
                  </div>
                  <p className="flex-[1_0_0] font-['Aeonik:Regular',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[#16121b] text-[20px] whitespace-pre-wrap">Le chat actuel, non adapté aux besoins produit sur la durée</p>
                </ContainerBackgroundImage1>
              </div>
            </ContainerBackgroundImage2>
          </div>
        ...
        <div className="content-stretch flex flex-col gap-[56px] items-start relative shrink-0 w-[946px]">
          <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[706px]" data-name="Container">
            ...
            <p className="font-['Aeonik:Bold',sans-serif] leading-[45px] not-italic relative shrink-0 text-[#16121b] text-[36px] w-[539px] whitespace-pre-wrap">Des livrables avancé pour un minimum “likable” product</p>
          </div>
          <div className="gap-x-[24px] gap-y-[24px] grid grid-cols-[repeat(5,minmax(0,1fr))] grid-rows-[repeat(2,fit-content(100%))] pointer-events-none relative shrink-0 w-full">
            <div className="col-[1/span_2] h-[341px] justify-self-stretch relative rounded-[30px] row-1 shrink-0">
              <BackgroundImage6>
            ...
            <div className="col-[1/span_3] h-[341px] justify-self-stretch relative rounded-[30px] row-2 shrink-0">
              <div aria-hidden="true" className="absolute inset-0 rounded-[30px]">
                <div className="absolute inset-0 overflow-hidden rounded-[30px]">
                  <img alt="" className="absolute h-[420.97%] left-0 max-w-none top-[-120.41%] w-[226.77%]" src={imgRectangle2067} />
                </div>
                <div className="absolute bg-[rgba(59,58,87,0.05)] inset-0 rounded-[30px]" />
              </div>
              <div aria-hidden="true" className="absolute border-4 border-[#e4e0f4] border-solid inset-0 rounded-[30px]" />
            </div>
            <Frame4BackgroundImage additionalClassNames="col-[3/span_3] row-1">
              <img alt="" className="absolute h-[285.34%] left-[-17.96%] max-w-none top-[-14.69%] w-[189.56%]" src={imgRectangle2066} />
            </Frame4BackgroundImage>
            <Frame4BackgroundImage additionalClassNames="col-[4/span_2] row-2">
        ...
        <div className="absolute flex h-[337.737px] items-center justify-center left-[546.25px] top-[7059.71px] w-[319.746px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "19" } as React.CSSProperties}>
      ...
      <div className="absolute h-[0.136px] left-[calc(42.86%-9.46px)] top-[4531.53px] w-0">
        <div className="absolute inset-[0_-2px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4 0.136254">
            <path d={svgPaths.p188b1c00} fill="var(--stroke-0, #633232)" id="Vector 25" />
          </svg>
        </div>
      </div>
    </div>
