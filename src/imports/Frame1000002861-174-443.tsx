...
import svgPaths from "./svg-q95lk2zguw";
...
function Component4Text({ text }: Component4TextProps) {
  return (
    <div className="content-stretch flex gap-[32px] h-[22px] items-center relative shrink-0 w-full">
...
function Component({ className, property1 = "Frame 1000002860" }: ComponentProps) {
  ...
  return (
    <div className={className || "relative w-[609px]"}>
      <div className="content-stretch flex flex-col gap-[40px] items-start relative w-full">
        {isFrame1000002860 && <p className="font-['Aeonik:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#40295b] text-[50px] tracking-[15px] uppercase w-[547px]">Experience</p>}
        <div className={`content-stretch flex relative shrink-0 w-full ${isFrame2087325871 ? "items-center" : "flex-col items-start"}`}>
          {isFrame1000002860 && (
            <>
              <div className="content-stretch flex gap-[32px] items-start relative shrink-0 w-full">
                <Wrapper>
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4 466">
                    <path d="M2 0V466" id="Vector 9" stroke="var(--stroke-0, #40295B)" strokeWidth="4" />
                  </svg>
                </Wrapper>
              ...
              <div className="content-stretch flex gap-[32px] items-start relative shrink-0 w-full">
                <Wrapper1>
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4 362.721">
                    <path d="M2 0V362.721" id="Vector 9" stroke="var(--stroke-0, #40295B)" strokeWidth="4" />
                  </svg>
                </Wrapper1>
              ...
              <Component4Text text="View my full profile on LinkedIn" />
            </>
          )}
          {isFrame2087325871 && <p className="flex-[1_0_0] font-['Aeonik:Regular',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[#40295b] text-[50px] tracking-[15px] uppercase">Experience</p>}
        </div>
        {isFrame2087325871 && (
          <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
            <button className="content-stretch cursor-pointer flex gap-[32px] items-start relative shrink-0 w-full">
              <Wrapper>
            ...
            <button className="content-stretch cursor-pointer flex gap-[32px] items-start relative shrink-0 w-full">
              <Wrapper2>
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4 95.7998">
                  <path d="M2 0V95.7998" id="Vector 9" stroke="var(--stroke-0, #40295B)" strokeWidth="4" />
                </svg>
              </Wrapper2>
              <Wrapper5>
...
export default function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[180px] items-start relative size-full">
      <Component className="relative shrink-0 w-full" property1="Frame 2087325871" />
      <div className="content-stretch flex flex-col gap-[40px] items-start relative shrink-0 w-full">
        <p className="font-['Aeonik:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#40295b] text-[50px] tracking-[15px] uppercase whitespace-nowrap">Education</p>
        <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
          <div className="content-stretch flex gap-[32px] h-[160px] items-start relative shrink-0 w-full">
      ...
      <div className="content-stretch flex flex-col font-['Aeonik:Regular',sans-serif] gap-[40px] items-start not-italic relative shrink-0 text-[#40295b] w-full">
        <p className="leading-[normal] relative shrink-0 text-[50px] tracking-[15px] uppercase whitespace-nowrap">Languages</p>
