  ...
  return (
    <div className="flex flex-col items-center shrink-0 self-stretch">
      ...
      <div
        ...
        style={{
          height: 16,
          background: isFirst ? "transparent" : "#40295b",
        }}
      />
      {/* Dot */}
      <div className="w-[16px] h-[16px] rounded-full border-[3px] border-[#40295b] shrink-0" />
      {/* Bottom line */}
      <div className="w-[4px] flex-1 bg-[#40295b]" />
    </div>
  );
}
      ...
      <div className="flex-1 min-w-0 pb-[20px]">
        ...
        >
          <div className="flex flex-col gap-[4px] min-w-0 flex-1">
            <p className="font-['Aeonik:Regular',sans-serif] not-italic text-[#3c3162] text-[20px]">
              {title}
            </p>
            <div className="flex flex-wrap items-center gap-x-[10px] gap-y-[2px]">
              <p className="font-['Aeonik:Regular',sans-serif] not-italic text-[#7a63ca] text-[12px] tracking-[2.5px] uppercase">
                {role}
              </p>
              <div className="bg-[#d7d0ef] h-[14px] w-[2px] shrink-0" />
              <p className="font-['Aeonik:Regular',sans-serif] not-italic text-[#7a63ca] text-[12px] tracking-[2.5px] uppercase">
                {period}
              </p>
            </div>
        ...
        {isOpen && (
          <div className="font-['Aeonik:Regular',sans-serif] not-italic text-[#40295b] text-[14px] leading-[20px] mt-[12px]">
            <p>{description}</p>
...
function EducationEntry({
  ...
  return (
    <div className="flex gap-[16px] items-stretch w-full">
      ...
      {/* Content */}
      <div className="flex-1 min-w-0 pb-[20px]">
        <p className="font-['Aeonik:Regular',sans-serif] not-italic text-[#40295b] text-[20px]">
          {school}
        </p>
        <p className="font-['Aeonik:Regular',sans-serif] not-italic text-[#7a63ca] text-[12px] tracking-[2.5px] uppercase mt-[4px]">
          {period}
        </p>
        <p className="font-['Aeonik:Regular',sans-serif] not-italic text-[#40295b] text-[14px] leading-[20px] mt-[4px]">
          {description}
        </p>
      </div>
    </div>
  ...
  return (
    <div className="flex flex-col gap-[60px] w-full px-[24px]">
      ...
      <div className="flex flex-col gap-[24px] w-full">
        <p className="font-['Aeonik:Regular',sans-serif] not-italic text-[#40295b] text-[24px] min-[450px]:text-[30px] tracking-[8px] uppercase">
          {exp.section_title}
        </p>
        <div className="flex flex-col w-full">
          ...
          <div className="flex gap-[16px] items-stretch w-full">
            ...
            <div className="flex flex-col items-center shrink-0 self-stretch">
              <div
                className="w-[4px] shrink-0"
                style={{ height: 16, background: "#40295b" }}
              />
            ...
            >
              <a
                ...
                className="font-['Aeonik:Regular',sans-serif] not-italic text-[#7a63ca] text-[14px] underline decoration-solid"
              >
                {exp.linkedin_cta}
              </a>
            </div>
      ...
      <div className="flex flex-col gap-[24px] w-full">
        ...
        <div className="flex flex-col gap-[16px]">
          {langs.items.map((l) => (
            <p
              key={l.language}
              className="font-['Aeonik:Regular',sans-serif] not-italic text-[#40295b] text-[17px] leading-[24px]"
            >
